...
/**
 * Min Stake block confirmations.
 * @const {Amount}
 * @default
 */
exports.STAKE_MIN_CONFIRMATIONS = 500;
...
/**
 * Add drift.
 * @param {nTime} block time
 * @returns {Number}
 */

exports.futureDriftV2 = function futureDriftV2(nTime) {
  return nTime + 15;
};

/**
 * Check start of 2n protocol.
 * @param {nTime} block time
 * @returns {Boolean}
 */

exports.isProtocolV2 = function isProtocolV2(nTime) {
  return nTime > 1407053678;
};

/**
 * Check start of 3rd protocol.
 * @param {nTime} block time
 * @returns {Boolean}
 */

exports.isProtocolV3 = function isProtocolV3(nTime) {
  return nTime > 1444028400;
};
...
exports.getStakeReward = function getStakeReward() {
  return exports.COIN * 3 / 2;
};
